...
Usage
Open perceptual-frequency-trainer.html in any modern browser (Chrome, Firefox, Edge, Safari)

Read and acknowledge the safety notice

Adjust the Target Frequency slider to your desired Hz

Press Play (or Space) to begin audio entrainment

Optionally enable Visual Sync to add strobe pulsing

Switch focus modality tabs (Point / Sensory / Aura) in the visual panel

Enable Binaural Mode toggle to switch from isochronic to binaural beats

Press P or the Psi Training button to open the intuition trainer

Press G at any time to pause and run the grounding protocol
